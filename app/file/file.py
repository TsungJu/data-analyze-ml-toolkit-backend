...
@file_blueprint.route('/api/guest/<first_name>/upload', methods=['POST'])
...
@file_blueprint.route('/api/guest/<first_name>/uploaded',methods=['GET'])
...
@file_blueprint.route('/api/guest/<first_name>/delete/<filename>', methods=['DELETE'])
...
@file_blueprint.route('/api/uploaded',methods=['GET'])
@jwt_required()
def uploaded():
...
@file_blueprint.route('/api/download/<filename>', methods=['GET'])
@jwt_required()
...
@file_blueprint.route('/api/delete/<filename>', methods=['DELETE'])
@jwt_required()
def delete(filename):
